...
class VacationItem extends StatelessWidget{
  ...
  VacationItem(this.index, this.filteredData);
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(
                      "${filteredData[index]['vacation_id']} - ${filteredData[index]['type_title_ar']}",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${filteredData[index]['start_date_vacation'].toString().tr} ",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontFamily:
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              const EdgeInsets.only(
                                  top: 6),
                              child: Text(
                                "${filteredData[index]['end_date_vacation'].toString().tr} ",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontFamily:
                                  CustomAppTheme
