...
class VacationRequest extends StatefulWidget {
  ...
  @override
  VacationRequestState createState() => VacationRequestState();
}

class VacationRequestState extends State<VacationRequest> {
  @override
      ...
      child: Scaffold(
            ...
            Expanded(
              child: TabBarView(
                children: [
                  ...
                  // ),
                  VacationRequestBody(selectIndex: 0 ),
                  VacationRequestBody(selectIndex: 1 ),
                  VacationRequestBody(selectIndex: 2 ),
                ],
              ),
            ),
          ],
        ...
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => AddVacationRequest()));
            }
        ),
      ),
    );
