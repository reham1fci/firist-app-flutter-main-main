...
class MaintenanceRequests extends StatefulWidget {
  const MaintenanceRequests({Key? key}) : super(key: key);

  @override
  MaintenanceRequestsState createState() => MaintenanceRequestsState();
}

class MaintenanceRequestsState extends State<MaintenanceRequests> {
  @override
            ...
            Expanded(
              child: TabBarView(
                children: [
                  ...
                  // ),
                  MaintenanceBody(selectIndex: 0 ),
                  MaintenanceBody(selectIndex: 1 ),
                  MaintenanceBody(selectIndex: 2 ),
                ],
              ),
            ),
          ],
