...
class ColorResources {
  ...
  static Color getGainsBoro(BuildContext context) {
    return Get.isDarkMode ? const Color(0xFF999999) : const Color(0xFFE6E6E6);
  }
  ...
  static Color getCheckoutTextColor() {
    return Get.isDarkMode ? const Color(0xFFFF8143) : const Color(0xFF4C5D70);
  }

  static Color getCategoryWithProductColor() {
    return Get.isDarkMode ? const Color(0xFF989797) : const Color(0xFFFFFFFF);
  }
  ...
  ///#686868
  static const Color COLOR_PRIMARY = Color(0xFFF7F9FC);
  ...
  static const Color COLOR_GREY = Color(0xffffffff);
  ...
  static const Color COLOR_TAB = Color(0xFFFDE6DA);
  static const Color COLOR_HINT = Color(0xFF52575C);
  static const Color SEARCH_BG = Color(0xFFF4F7FC);
  static const Color COLOR_GRAY = Color(0xffffffff);
  ...
  static const Color COLOR_GREY_CHATEAU = Color(0xfff7f9fc);
  ...
  static Color cardOrangeColor = const Color(0xFFF5F5F5);
  ...
  static Color themeLightBackgroundColor = const Color(0xFFF5F5F5);
  static Color themeDarkBackgroundColor = const Color(0xFF343636);
  //other info
  //#6a6e81
  static Color genderDefaultColor = const Color(0xfff5f5f5);
